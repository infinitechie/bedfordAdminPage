(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("rxjs/Observable"), require("rxjs/add/observable/fromEvent"), require("rxjs/add/observable/merge"), require("rxjs/add/operator/map"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/takeUntil"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/core", "rxjs/Observable", "rxjs/add/observable/fromEvent", "rxjs/add/observable/merge", "rxjs/add/operator/map", "rxjs/add/operator/mergeMap", "rxjs/add/operator/takeUntil"], factory);
	else if(typeof exports === 'object')
		exports["ng2-slimscroll"] = factory(require("@angular/core"), require("rxjs/Observable"), require("rxjs/add/observable/fromEvent"), require("rxjs/add/observable/merge"), require("rxjs/add/operator/map"), require("rxjs/add/operator/mergeMap"), require("rxjs/add/operator/takeUntil"));
	else
		root["ng2-slimscroll"] = factory(root["@angular/core"], root["rxjs/Observable"], root["rxjs/add/observable/fromEvent"], root["rxjs/add/observable/merge"], root["rxjs/add/operator/map"], root["rxjs/add/operator/mergeMap"], root["rxjs/add/operator/takeUntil"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_fromEvent__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_observable_merge__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_mergeMap__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_mergeMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_mergeMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_takeUntil__ = __webpack_require__(9);
...
var SlimScrollDirective = (function () {
    function SlimScrollDirective(viewContainer, renderer) {
        ...
        this.initWheel = function () {
            var dommousescroll = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(_this.el, 'DOMMouseScroll');
            var mousewheel = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(_this.el, 'mousewheel');
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].merge.apply(__WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"], [dommousescroll, mousewheel]).subscribe(function (e) {
                var delta = 0;
                if (e.wheelDelta) {
        ...
        this.initDrag = function () {
            var bar = _this.bar;
            var mousemove = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(document.documentElement, 'mousemove');
            var touchmove = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(document.documentElement, 'touchmove');
            var mousedown = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(bar, 'mousedown');
            var touchstart = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(_this.el, 'touchstart');
            var mouseup = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(document.documentElement, 'mouseup');
            var touchend = __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].fromEvent(document.documentElement, 'touchend');
            ...
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].merge.apply(__WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"], [mousedrag, touchdrag]).subscribe(function (top) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].merge.apply(__WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"], [mouseup, touchend]).subscribe(function () {
